...
path('manager/messages/',views.md_messages, name='messages'),
path('manager/messages/employees',views.md_messages_emps, name='messages'),
path('manager/messages/clients',views.md_messages_clients, name='messages'),
path('manager/finances/',views.md_finances, name='messages'),
path('manager/updates/',views.md_updates, name='messages'),
